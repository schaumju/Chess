...
public class Knight extends Piece {
    ...
    public boolean isColumnExclusion(final int currentPosition, final int candidateOffset) {
        return isFirstColumnExclusion(currentPosition, candidateOffset) || isSecondColumnExclusion(currentPosition, candidateOffset) || isSeventhColumnExclusion(currentPosition, candidateOffset) || isEighthColumnExclusion(currentPosition, candidateOffset);
    }
    @Override
    ...
    /**
     * Capture edge cases for when the piece is in the first column
    ...
    /**
     * Capture edge cases for when the piece is in the second column
    ...
    /**
     * Capture edge cases for when the piece is in the seventh column
     * @param currentPosition the current position of the night
     * @param candidateOffset the candidate offset move for the knight
     * @return true if the location of the piece and the offset would violate the rule
     */
